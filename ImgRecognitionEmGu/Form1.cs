...
namespace ImgRecognitionEmGu
{
    public partial class Form1 : Form
    {
        ...
        const string _detailedImage = @"E:\Desktop\ImgRecognitionEmGu\ImgRecognitionEmGu\resources\target\broccoli.jpg";
        ...
        private void ProcessImage(string completeImage, string detailImage)
        {
            ...
            try
            {
                ...
                using (Mat modelImage = CvInvoke.Imread(detailImage, ImreadModes.AnyColor))
                using (Mat observedImage = CvInvoke.Imread(completeImage, ImreadModes.AnyColor))
                {
                    Mat homography;
        ...
        {
            ProcessFolder(@"E:\Desktop\ImgRecognitionEmGu\ImgRecognitionEmGu\resources\test", _detailedImage);
